...
interface SettingsProps {
  onClose: () => void;
  onSave: (settings: { ttl_seconds: TtlOption }) => Promise<void>;
}
      ...
      <div className="w-full bg-surface border-t border-border rounded-t-xl p-5 flex flex-col gap-5">
        ...
        <div className="border border-border rounded p-3 flex flex-col gap-1.5">
          ...
          <p className="text-[10px] text-muted leading-relaxed">
            messages stored in RAM only. x3dh key exchange + double ratchet e2ee.
            embedded i2p router — no ip exchange, no external dependencies.
          </p>
        </div>
